...
import { useStartupFindFirst, useRoqClient } from 'lib/roq';
...
function StartupViewPage() {
  ...
  const { data, error, isLoading } = useStartupFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('startup', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/startups/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="startup" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
