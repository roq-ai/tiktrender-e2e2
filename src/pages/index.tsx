...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`TikTrender`}</title>

        <meta
          name="description"
          content="Welcome to TikTrender, your ultimate tool for crafting compelling TikTok titles and trend-aligned hashtags. Enhance your content's discoverability, align with the latest trends, and make every post count. Ideal for creators, marketers, and TikTok enthusiasts alike."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1597075095400-fb3f0de70140?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxUaWtUb2t8ZW58MHx8fHwxNjk5ODk2NDMxfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@helloimnik?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Nik`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to TikTrender, your ultimate tool for crafting compelling TikTok titles and trend-aligned hashtags. Enhance your content's discoverability, align with the latest trends, and make every post count. Ideal for creators, marketers, and TikTok enthusiasts alike.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Digital Marketing Manager" type="default" abilities={appConfig.ownerAbilities} />

                <Card userTypeName="Individual User" type="individual-user" abilities={appConfig.customerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
