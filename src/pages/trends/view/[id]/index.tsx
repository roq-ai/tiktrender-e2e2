...
import { useTrendFindFirst, useRoqClient } from 'lib/roq';

import { TrendInterface } from 'interfaces/trend';
import { VideoTrendListPage } from 'pages/video-trends';

function TrendViewPage() {
  ...
  const { data, error, isLoading } = useTrendFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('trend', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/trends/edit/${id}`} passHref legacyBehavior>
                    <Button
