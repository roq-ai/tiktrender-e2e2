...
import { useVideoFindFirst, useRoqClient } from 'lib/roq';

import { VideoInterface } from 'interfaces/video';
import { HashtagListPage } from 'pages/hashtags';
...
function VideoViewPage() {
  ...
  const { data, error, isLoading } = useVideoFindFirst(queryParams, {}, { disabled: !id });
